...
canvas.height = window.innerHeight-157
...
var X
var Y
tileW= 20;          // width of each tile
tileH= 20;          // height of each tile
tileRow=(Height/23);        // number of rows in grid
tileColumn= (Width/23);                     // number of columns in grid
boundX=0;
boundY=0;
